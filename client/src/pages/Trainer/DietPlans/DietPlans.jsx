...
import { Plus, Search, Utensils, Edit, Trash2, Clipboard } from 'lucide-react';
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    <h1 style={{ fontSize: '2rem', fontWeight: '900' }}>Manage Diet Plans</h1>
                    <p style={{ color: 'var(--muted-foreground)' }}>Assign and monitor nutrition for your assigned members</p>
                </div>
